 ...
 */
//namespace Prayer\SocialBundle\Service\Google\lib\auth;
...
class Google_OAuth2 extends Google_Auth {
  ...
  public function authenticate($service, $code = null) {
    ...
    if ($code) {
      ...
      $request = GoogleClient::$io->makeRequest(new Google_HttpRequest(self::OAUTH2_TOKEN_URI, 'POST', array(), array(
          'code' => $code,
